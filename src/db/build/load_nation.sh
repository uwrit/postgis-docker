...
cd $GISDATA
echo "${PWD}"
wget https://www2.census.gov/geo/tiger/TIGER2017/STATE/tl_2017_us_state.zip --mirror --reject=html --no-verbose
...
cd $GISDATA
wget https://www2.census.gov/geo/tiger/TIGER2017/COUNTY/tl_2017_us_county.zip --mirror --reject=html --no-verbose
